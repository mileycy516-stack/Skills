...
description: Generates high-quality, predictable, and efficient .agent/skills/ directories based on user requirements. Use whenever you need to create a new skill or modify an existing one.
---
