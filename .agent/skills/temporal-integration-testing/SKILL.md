---
name: temporal-integration-testing
description: Comprehensive patterns for testing Temporal workflows with mocked external dependencies, error injection, and complex scenarios using the Python SDK.
allowed-tools: Pytest, Temporalite
---
